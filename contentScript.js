...
chrome.storage.local.get({ privateReply: true, highlightRating: true, disableOnBeforeUnload: true, alertNoGrading: true }, (options) => {
  const { privateReply, highlightRating, disableOnBeforeUnload, alertNoGrading } = options;
